...
const ListarBeneficiarios = (user) => {
  ...
  const columns = [{ accessorKey: 'accion', header: 'Accion', }, { accessorKey: 'detalle', header: 'Detalle', }, { accessorKey: 'fecha', header: 'Fecha', }, { accessorKey: 'servicio', header: 'Servicio', }, { accessorKey: 'usuario', header: 'Usuario', },];
