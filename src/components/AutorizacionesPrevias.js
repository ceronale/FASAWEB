...
const AutorizacionPrevia = (user) => {
    ...
    const columns = useMemo(
        () => [{ accessorKey: 'LAPB_416_ID_AP', header: 'ID', enableEditing: false }, { accessorKey: 'credencial', header: 'Credencial' }, { accessorKey: 'codigo', header: 'Código Carga' }, { accessorKey: 'LAPB_FECHA_INICIO', header: 'Fecha Inicio' }, { accessorKey: 'LAPB_FECHA_TERMINO', header: 'Fecha Término' }, { accessorKey: 'LAPB_INCLUIR_EXCLUIR', header: 'Exclusión/Inclusión' },{ accessorKey: 'campo', header: 'Nombre Campo' },{ accessorKey: 'LAPB_VALOR_CAMPO', header: 'Valor Campo' },{ accessorKey: 'producto', header: 'Producto' },{ accessorKey: 'LAPB_Q_ENVASES_MENSUAL', header: 'Max Envases' }, { accessorKey: 'LAPB_ACUMULADO_ENVASES_MENSUAL', header: 'Acumulados', enableEditing: false },{ accessorKey: 'PLA_524_PLAN_ID', header: 'Plan' },{ accessorKey: 'LMA_ID_MEDICO', header: 'Rut Medico' }, { accessorKey: 'LAPB_MEDICO_INCEXC', header: 'Exclusión/Inclusión Medico' }, { accessorKey: 'codigoPersona', header: 'Código Persona' }],
        []
    );
